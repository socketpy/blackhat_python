...
# this is a pretty hex dumping func
...
def receive_from(connection):
    ...
    # we set a 3 sec timeout; depending on your target, this may need to be adjusted
...
def request_handler(buffer):
    ...
    buffer += 'request_added'
    return buffer

# modify any responses destined for the local host
def response_handler(buffer):
    #perform packet modifications
    buffer += 'response_added'
    return buffer
